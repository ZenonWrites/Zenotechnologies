    ...
    <section className="w-full bg-black px-10 py-20">
      <div className="grid md:grid-cols-2 gap-16 items-start">
        ...
        <div className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden bg-gradient-to-br from-slate-800 to-slate-900">
          <div className="absolute inset-0 flex items-center justify-center">
            <button
              ...
              className="w-28 h-28 rounded-full bg-white flex items-center justify-center hover:scale-105 transition-transform"
            >
              <Play className="text-black ml-1" size={22} fill="black" />
            </button>
          </div>
          <span className="absolute bottom-6 left-6 text-white/70 text-sm tracking-wide">
            Play
          </span>
        </div>
        ...
        <div className="flex flex-col gap-10">
          <div>
            <span className="text-red-600 text-6xl leading-none font-serif">&ldquo;</span>
            <p className="text-white/90 text-xl leading-relaxed -mt-4">{slide.quote}</p>
          ...
          <div>
            <div className="text-white text-6xl font-bold">{slide.clients}</div>
            <div className="text-white/60 tracking-wide mt-1">{slide.label}</div>
          </div>
        </div>
      </div>
